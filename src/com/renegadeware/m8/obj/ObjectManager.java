...
public class ObjectManager extends BaseObject {
    ...
    public boolean hasPendingUpdates() {
    	if(mPendingAdditions.getCount() > 0) {
    		return true;
    	}
    	
    	return mPendingRemovals.getCount() > 0;
    }
    ...
    public final int getPendingCount() {
    	return mPendingAdditions.getCount();
    }
    ...
    public final BaseObject getLast() {
    	return mObjects.getLast();
    }
    ...
    public int find(BaseObject object) {
    	return mObjects.find(object, true);
    }
    ...
    protected FixedSizeArray<BaseObject> getPendingAdditions() {
