...
public abstract class ObjectPool extends BaseObject {
    ...
    /** debug purpose */
    protected boolean find(Object o) {
    	return mAvailable.find(o, true) != -1;
    }
    ...
    protected Object allocate() {
        ...
        /*assert result != null : "Object pool of type " + this.getClass().getSimpleName()
                                + " exhausted!!";*/
        if(result == null) {
        	DebugLog.e("ObjectPool", "Object pool of type " + this.getClass().getSimpleName()
                    + " exhausted!!");
        }
        return result;
    }
